#
#  Be sure to run `pod spec lint Infinity.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Alfian Losari" => "alfianlosari@gmail.com" }
  # Or just: spec.author    = "Alfian Losari"
  # spec.authors            = { "Alfian Losari" => "alfianlosari@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Alfian Losari"
